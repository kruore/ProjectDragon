...
public class Targetpoint : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        boss = GameObject.Find("골렘").GetComponent<Boss_MaDongSeok>();
    }
    ...
    public Targetpoint Create(float _speed, int _damage,string poolItemName, Vector3 position, Transform parent = null)
    {
        ...
        Debug.Log(targetpointobj.transform.Find("Projectile").transform.position+"aaaa"+ targetpointobj.transform.Find("Projectile").transform.localPosition);
